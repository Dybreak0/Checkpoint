...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210602183300_RenameToFileName")]
    partial class RenameToFileName
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "856daa55-14a0-4439-a157-94ade1663091",
                            ConcurrencyStamp = "a2fbc5d9-5759-40aa-805d-5e011e602f35",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "7789bf02-05a5-4af8-b9b1-e04a1e3e6a4c",
                            ConcurrencyStamp = "9d0382ba-4119-4b1a-b79b-c3d4f86a4e6b",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 211, DateTimeKind.Local).AddTicks(9267),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 213, DateTimeKind.Local).AddTicks(3365)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 216, DateTimeKind.Local).AddTicks(1840),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 216, DateTimeKind.Local).AddTicks(2384)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 216, DateTimeKind.Local).AddTicks(3021),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 216, DateTimeKind.Local).AddTicks(3028)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(2439),
                            DateTimeEnd = new DateTime(2021, 6, 3, 2, 32, 59, 214, DateTimeKind.Local).AddTicks(9976),
                            DateTimeStart = new DateTime(2021, 6, 3, 2, 32, 59, 214, DateTimeKind.Local).AddTicks(9668),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(2839)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(3643),
                            DateTimeEnd = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(3608),
                            DateTimeStart = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(3603),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 2, 32, 59, 215, DateTimeKind.Local).AddTicks(3649)
                        });
                });
