...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210531051430_BoolToStringLoanStatus")]
    partial class BoolToStringLoanStatus
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "48112c74-1d0e-4225-bbe2-aa7807cac200",
                            ConcurrencyStamp = "8d92e729-107f-40ed-bce7-b0ad7a7b4a83",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "1cdc10b3-dcc0-4a16-a071-a862f6b9aa4b",
                            ConcurrencyStamp = "58a02e73-d6f1-4e3c-9129-353a95bb5e63",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 625, DateTimeKind.Local).AddTicks(3823),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 626, DateTimeKind.Local).AddTicks(198)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(7253),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(7657)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(8065),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(8072)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(599),
                            DateTimeEnd = new DateTime(2021, 5, 31, 13, 14, 29, 626, DateTimeKind.Local).AddTicks(8494),
                            DateTimeStart = new DateTime(2021, 5, 31, 13, 14, 29, 626, DateTimeKind.Local).AddTicks(8280),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(922)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(1445),
                            DateTimeEnd = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(1411),
                            DateTimeStart = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(1407),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 13, 14, 29, 627, DateTimeKind.Local).AddTicks(1451)
                        });
                });
