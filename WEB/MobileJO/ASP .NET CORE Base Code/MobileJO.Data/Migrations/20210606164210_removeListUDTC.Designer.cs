...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210606164210_removeListUDTC")]
    partial class removeListUDTC
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "015330a8-59c1-40a1-83a8-ab136287f3b4",
                            ConcurrencyStamp = "ab408c90-5e28-4034-9b60-5fcb8acf0ff9",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "8b34843a-0f54-4421-83af-fce5abebbd43",
                            ConcurrencyStamp = "d9861d4f-40fa-4a3f-ba57-eb02d0095bac",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 762, DateTimeKind.Local).AddTicks(1812),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 762, DateTimeKind.Local).AddTicks(7659)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 764, DateTimeKind.Local).AddTicks(3339),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 764, DateTimeKind.Local).AddTicks(3804)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 764, DateTimeKind.Local).AddTicks(4195),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 764, DateTimeKind.Local).AddTicks(4202)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(7326),
                            DateTimeEnd = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(5279),
                            DateTimeStart = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(5065),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(7653)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(8178),
                            DateTimeEnd = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(8143),
                            DateTimeStart = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(8139),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 7, 0, 42, 8, 763, DateTimeKind.Local).AddTicks(8183)
                        });
                });
