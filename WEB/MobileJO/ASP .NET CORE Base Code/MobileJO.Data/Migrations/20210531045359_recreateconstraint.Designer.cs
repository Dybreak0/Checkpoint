...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210531045359_recreateconstraint")]
    partial class recreateconstraint
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e089ba03-1ac7-4297-b2c4-15b2fcf6a961",
                            ConcurrencyStamp = "222145d0-948b-4ae1-bd4f-e38894c5600b",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "245d2ce9-3ecf-4b31-8f8a-2ecb50338774",
                            ConcurrencyStamp = "2c7e2979-a817-4665-8d8e-ad7374dbc718",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 979, DateTimeKind.Local).AddTicks(2974),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 980, DateTimeKind.Local).AddTicks(3686)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 983, DateTimeKind.Local).AddTicks(3600),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 983, DateTimeKind.Local).AddTicks(4281)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 983, DateTimeKind.Local).AddTicks(4919),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 983, DateTimeKind.Local).AddTicks(4931)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(1200),
                            DateTimeEnd = new DateTime(2021, 5, 31, 12, 53, 58, 981, DateTimeKind.Local).AddTicks(7700),
                            DateTimeStart = new DateTime(2021, 5, 31, 12, 53, 58, 981, DateTimeKind.Local).AddTicks(7332),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(2057)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(3142),
                            DateTimeEnd = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(3072),
                            DateTimeStart = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(3061),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 12, 53, 58, 982, DateTimeKind.Local).AddTicks(3151)
                        });
                });
