...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210531005253_fixapplicationNo")]
    partial class fixapplicationNo
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1bcebdff-cf51-4052-89e0-575670c6123c",
                            ConcurrencyStamp = "f912c224-6ebf-4f3d-a03a-1e89a9597269",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "8f5b680e-824c-4d0f-9656-dd7898dbcb49",
                            ConcurrencyStamp = "a2114ff3-f036-4c23-9136-38d986005b13",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 891, DateTimeKind.Local).AddTicks(5900),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 892, DateTimeKind.Local).AddTicks(1947)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(8248),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(8631)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(8995),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(9001)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(1857),
                            DateTimeEnd = new DateTime(2021, 5, 31, 8, 52, 52, 892, DateTimeKind.Local).AddTicks(9793),
                            DateTimeStart = new DateTime(2021, 5, 31, 8, 52, 52, 892, DateTimeKind.Local).AddTicks(9572),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(2179)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(2823),
                            DateTimeEnd = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(2789),
                            DateTimeStart = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(2785),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 5, 31, 8, 52, 52, 893, DateTimeKind.Local).AddTicks(2829)
                        });
                });
