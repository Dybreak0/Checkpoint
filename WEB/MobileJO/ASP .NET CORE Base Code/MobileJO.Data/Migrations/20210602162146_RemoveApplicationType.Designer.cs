...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210602162146_RemoveApplicationType")]
    partial class RemoveApplicationType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "50fc633a-1596-4dc7-9606-f6845cffd5be",
                            ConcurrencyStamp = "f0fd150d-8f0a-4a91-958f-75c56f562708",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "cb4f8638-208e-45e1-bcad-07d664ed0964",
                            ConcurrencyStamp = "7ed1fc46-16d6-40b6-92a9-65722b2c477a",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 722, DateTimeKind.Local).AddTicks(167),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 723, DateTimeKind.Local).AddTicks(1036)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 726, DateTimeKind.Local).AddTicks(4723),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 726, DateTimeKind.Local).AddTicks(5303)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 726, DateTimeKind.Local).AddTicks(5908),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 726, DateTimeKind.Local).AddTicks(5924)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(1941),
                            DateTimeEnd = new DateTime(2021, 6, 3, 0, 21, 45, 724, DateTimeKind.Local).AddTicks(8381),
                            DateTimeStart = new DateTime(2021, 6, 3, 0, 21, 45, 724, DateTimeKind.Local).AddTicks(7983),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(2479)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(3354),
                            DateTimeEnd = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(3292),
                            DateTimeStart = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(3286),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 3, 0, 21, 45, 725, DateTimeKind.Local).AddTicks(3363)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.LoanApplicationType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("MobileJO.Data.Models.LoanCreditHistory", b =>
                {
                    ...
                    b.Property<string>("HistoryRemainingBalance")
            ...
            modelBuilder.Entity("MobileJO.Data.Models.LoanStatus", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("MobileJO.Data.Models.LoanUnitDesired", b =>
                {
                    ...
                    b.Property<string>("DesiredAmount")
            ...
            modelBuilder.Entity("MobileJO.Data.Models.LoanUnitDesiredTC", b =>
                {
                    ...
                    b.Property<string>("DesiredTCDownPayment")
                        .HasColumnName("DesiredTCDownPayment")
                        .HasColumnType("varchar(255)");

                    b.Property<string>("DesiredTCMonthlyInstallment")
                    ...
                    b.Property<string>("DesiredTCTotalPrice")
                        .HasColumnName("DesiredTCTotalPrice")
                        .HasColumnType("varchar(255)");

                    b.Property<string>("DesiredTCTotalRebate")
