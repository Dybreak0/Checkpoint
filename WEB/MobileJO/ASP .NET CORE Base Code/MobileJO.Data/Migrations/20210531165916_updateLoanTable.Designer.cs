...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210531165916_updateLoanTable")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "337a8f2a-8a12-4a6b-9001-6aacec3b97b3",
                            ConcurrencyStamp = "2fe4067c-7499-409f-8ac5-18541ca21498",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "aaf3835d-9a5a-4626-8395-70d99f11ffa0",
                            ConcurrencyStamp = "37fed3f3-f6a6-407e-ab8c-16f73acd674b",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 936, DateTimeKind.Local).AddTicks(8555),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 937, DateTimeKind.Local).AddTicks(4272)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 939, DateTimeKind.Local).AddTicks(574),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 939, DateTimeKind.Local).AddTicks(971)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 939, DateTimeKind.Local).AddTicks(1344),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 939, DateTimeKind.Local).AddTicks(1350)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(4289),
                            DateTimeEnd = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(2305),
                            DateTimeStart = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(2080),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(4613)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(5148),
                            DateTimeEnd = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(5113),
                            DateTimeStart = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(5108),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 1, 0, 59, 15, 938, DateTimeKind.Local).AddTicks(5154)
                        });
                });
