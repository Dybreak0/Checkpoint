...
namespace MobileJO.Data.Migrations
{
    ...
    [Migration("20210606140934_fixApprovedBy")]
    partial class fixApprovedBy
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4dbb2914-4940-4979-95f5-2cefa06a45b7",
                            ConcurrencyStamp = "6dc09bb5-8283-452b-83fa-c7d4c588cb98",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "8a29acbc-3789-41db-b40e-29271fd2ee18",
                            ConcurrencyStamp = "5cbe23e4-cc22-4906-b3a2-7d3ec6ecc2d0",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 458, DateTimeKind.Local).AddTicks(7200),
                            EmailAddress = "sampleaccount@email.com",
                            IsActive = true,
                            Memo = "Sample Memo",
                            Name = "Sample Account",
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 459, DateTimeKind.Local).AddTicks(3435)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.AssignedCase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(9988),
                            Description = "Sample Description",
                            Priority = "Priority1",
                            Status = "Ongoing",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 461, DateTimeKind.Local).AddTicks(366)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 461, DateTimeKind.Local).AddTicks(744),
                            Description = "Sample Description 2",
                            Priority = "Priority2",
                            Status = "Pending",
                            UpdatedBy = "admin",
                            UpdatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 461, DateTimeKind.Local).AddTicks(750)
                        });
                });
            ...
            modelBuilder.Entity("MobileJO.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(3455),
                            DateTimeEnd = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(1400),
                            DateTimeStart = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(1176),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = false,
                            ...
                            StatusID = 1,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(3793)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(4473),
                            DateTimeEnd = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(4438),
                            DateTimeStart = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(4434),
                            IsBilled = true,
                            IsCollaterals = true,
                            IsDeleted = false,
                            IsFixed = true,
                            ...
                            StatusID = 2,
                            UpdatedBy = 1,
                            UpdatedDate = new DateTime(2021, 6, 6, 22, 9, 33, 460, DateTimeKind.Local).AddTicks(4478)
                        });
                });
